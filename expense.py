...
st.set_page_config(page_title="MoneyMap Tracker", page_icon="💰", layout="centered")
...
st.markdown("<h1 style='text-align: center; color: #808080;'>💰 MoneyMap Tracker</h1>", unsafe_allow_html=True)
